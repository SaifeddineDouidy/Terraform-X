...
vpc_cidr            = "10.1.0.0/16"          # CIDR block for the VPC
...
environment = "uat"    # Current deployment environment
...
rds_backup_s3_bucket_name = "my-uat-rds-backup-bucket"
